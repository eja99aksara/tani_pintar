...
# =================================================================
# --- FRAME A: HERO SECTION (Rapi Kiri, Tombol Pendek & Sempurna) ---
# =================================================================
hero_html = f"""<div style="background-image: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('{bg_hero}'); background-size: cover; background-position: center; background-repeat: no-repeat; padding: 35px 20px; border-radius: 12px; color: white; display: flex; flex-direction: column; align-items: flex-start; text-align: left; gap: 12px; margin-bottom: 30px; font-family: sans-serif;">
    ...
    <a href="{nomor_admin_wa}" target="_blank" style="background-color: #2d5a27; color: white; padding: 6px 14px; border-radius: 20px; text-decoration: none; font-weight: bold; font-size: 0.75rem; display: inline-block; width: max-content; box-shadow: 0 4px 6px rgba(0,0,0,0.3); border: 1px solid rgba(255,255,255,0.2);">Konsultasi Gratis (WA)</a>
</div>"""
