...
# Membungkus dengan kontainer dan menerapkan CSS
with st.container():
    ...
    with col1:
        st.write("Logo")
    with col2:
        st.markdown("<h1 style='text-align: center; color: white;'>Ubah Kebun Anda Menjadi Cerdas</h1>", unsafe_allow_html=True)
    with col3:
